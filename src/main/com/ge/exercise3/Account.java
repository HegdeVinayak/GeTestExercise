...
public class Account {
	...
	//Remove static attribute as montly intrest and fee can change based on account type
    ...
    public void withdraw(float amount) {
    	//Restricting checking account to overdrawn by more than $100
    	if(accountType == "Checking" && amount > 100)
    	{
    		return;
    	}
    	
    	//Avoid savings account from having negative balance
    	if(accountType == "Savings" && amount > balance)
    	{
    		return;
    	}
